		...
		move || {
			testnet_genesis(
				...
				vec![
					...
					authority_keys_from_seed("Ferdiel"),
					authority_keys_from_seed("Ferdiell")
				],
				vec![],
				// Sudo account
				get_account_id_from_seed::<sr25519::Public>("Alice"),
				...
				vec![
					...
					get_account_id_from_seed::<sr25519::Public>("Ferdiel"),
					get_account_id_from_seed::<sr25519::Public>("Ferdiell"),
					get_account_id_from_seed::<sr25519::Public>("Ferdielll"),
					get_account_id_from_seed::<sr25519::Public>("Alice//stash"),
					get_account_id_from_seed::<sr25519::Public>("Bob//stash"),
					...
					get_account_id_from_seed::<sr25519::Public>("Ferdiel//stash")
				],
			)
		},
		// Bootnodes
